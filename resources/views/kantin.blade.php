@include ('navbar')
  ...
  <H2 style="font-family:Garamond ;" class="text-center">Denah Kantin Satu Lantai Satu</H2>
        ...
        <div class="col-md-3">
            ...
            <div class="card p-3 mb-2" style="box-shadow: 1px 1px 1px 1px rgba(20,20,20,0.4); width:100%; height:100px" >
                ...
                <div class="mt-2">
                  <div class="row">
                    <div class="col-md-6">  
                    <h7 class="text-left">{{$tampil -> nama}} </h7>     
                    </div>
                  <div class="col-md-6">

                    <h7 class="text-right">{{$tampil -> namadua}}</h7>
                    </div>
