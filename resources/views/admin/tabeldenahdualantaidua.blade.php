          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Denah Kantin Dua Lantai Dua</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <a href="{{asset('template')}}/denah.xlsx" class="btn btn-primary mb-5" download>Unduh Template</a>
              <div style="margin-top: 15px;">
            <form role="form" method="post" action="{{ url('siswa/duadua') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="box-body">
                ...
                <a href="{{url('createkantindualantaidua   ')}}" class="btn btn-primary mb-5">+Tambah Mahasiswa</a>
