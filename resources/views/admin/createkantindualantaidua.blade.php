...
<form role="form" action="{{route('kantindualantaidua.store')}}" method="POST" enctype="multipart/form-data">
{{ csrf_field() }}
<div class="form-group">
  ...
  <a href="{{url('tabeldenahdualantaidua ')}}" class="btn btn-primary">Kembali</a>
</form>
</div>
